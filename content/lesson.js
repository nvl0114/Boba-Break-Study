...
const allLessonsData = {
    ...
    7: {
        grammar: [
            ...
            {
                id: "subject_not_at_place",
                name: "Subject + 不在 + Place",
                category: "Locations & Presence",
                examples: ["他不在公園。", "香蕉不在學校。"]
            },
            {
                id: "subject_at_place_ma",
                name: "Subject + 在 + Place + 嗎？",
                category: "Locations & Presence",
                examples: ["老師在教室嗎？", "爸爸在辦公室嗎？"]
            },
            {
                id: "subject_zai_bu_zai_place",
                name: "Subject + 在不在 + Place",
                category: "Locations & Presence",
                examples: ["他在不在日本？", "護士在不在醫院？"]
            },
            {
                id: "zai_bu_zai_presence",
                name: "在不在 / 在嗎",
                category: "Locations & Presence",
                examples: ["她在嗎？", "哥哥在不在？"]
            },
            ...
            {
                id: "subject_zai_place_activity",
                name: "Subject + 在 + Place + Activity",
                category: "Locations with Activities",
                examples: ["哥哥在日本讀書。", "弟弟在家玩遊戲。"]
            },
            {
                id: "subject_bu_zai_place_activity",
                name: "Subject + 不在 + Place + Activity",
                category: "Locations with Activities",
                examples: ["老師不在醫院工作。", "醫生不在教室教學。"]
            },
            {
                id: "subject_zai_place_activity_ma",
                name: "Subject + 在 + Place + Activity + 嗎？",
                category: "Locations with Activities",
                examples: ["妹妹在學校上課嗎？", "他在公園運動嗎？"]
            },
            {
                id: "subject_zai_bu_zai_place_activity",
                name: "Subject + 在不在 + Place + Activity",
                category: "Locations with Activities",
                examples: ["你們在不在家吃蘋果和香蕉？"]
            },
            {
                id: "subject_zai_nali_activity",
                name: "Subject + 在 + 哪裡 + Activity",
                category: "Locations with Activities",
                examples: ["爸爸在哪裡上班？"]
            }
        ],
        vocabulary: [
            ...
            { hanzi: "讀書", pinyin: "dúshū", meaning: "to study / read books", category: "Verb" },
            { hanzi: "上班", pinyin: "shàngbān", meaning: "to go to work", category: "Verb" },
        ...
        reviewQuestions: [
            { meaning: "The doctor is at the hospital.", answer: ["醫", "生", "在", "醫", "院"] },
            { meaning: "Where is mom?", answer: ["媽", "媽", "在", "哪", "里"] },
            { meaning: "Older brother studies in Japan.", answer: ["哥", "哥", "在", "日", "本", "讀", "書"] }
        ]
    }
