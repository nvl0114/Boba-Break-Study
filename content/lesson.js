...
18: {
    grammar: [
        {
            id: "grammar-juéde",
            name: "覺得 — To Think / Feel",
            category: "Feelings & Opinions",
            explanation: "覺得 means 'to think' or 'to feel'. It is commonly used when giving your personal opinion or describing how something seems to you. The structure is Subject + 覺得 + statement.",
            examples: [
                "我覺得小安很可愛。",
                "Wǒ juéde Xiǎo Ān hěn kě'ài.",
                "I think Xiao An is very cute.",
                "我覺得今天很好。",
                "Wǒ juéde jīntiān hěn hǎo.",
                "I think today is good."
            ]
        },
        {
            id: "grammar-chángcháng-píngcháng",
            name: "常常 / 平常 — Often / Usually",
            category: "Frequency & Habits",
            explanation: "常常 means 'often', describing an action that happens frequently. 平常 means 'usually / normally', describing what normally happens in someone's routine.",
            examples: [
                "他常常跟朋友說話。",
                "Tā chángcháng gēn péngyǒu shuōhuà.",
                "He often talks with his friends.",
                "我平常在班上吃午餐。",
                "Wǒ píngcháng zài bān shàng chī wǔcān.",
                "I usually eat lunch in class."
            ]
        },
        {
            id: "grammar-zuìjìn",
            name: "最近 — Recently / Lately",
            category: "Time Expressions",
            explanation: "最近 means 'recently' or 'lately'. It refers to a period close to the present and is often placed at the beginning of the sentence.",
            examples: [
                "最近我很忙。",
                "Zuìjìn wǒ hěn máng.",
                "I have been very busy recently.",
                "最近阿豪常常找小安。",
                "Zuìjìn Āháo chángcháng zhǎo Xiǎo Ān.",
                "Recently, Ahao often looks for Xiao An."
            ]
        },
        {
            id: "grammar-xiǎng",
            ...
            explanation: "想 can mean 'want to' when it comes before another verb, expressing a desire or intention to do something.",
            examples: [
                "我想跟小安說話。",
                "Wǒ xiǎng gēn Xiǎo Ān shuōhuà.",
                "I want to talk with Xiao An.",
                "他想坐在小安旁邊。",
                "Tā xiǎng zuò zài Xiǎo Ān pángbiān.",
                "He wants to sit beside Xiao An."
            ]
        },
        {
            id: "grammar-yǒu-shíhou",
            name: "有時候 — Sometimes",
            category: "Frequency",
            explanation: "有時候 means 'sometimes'. It describes an action that happens occasionally, but not every time.",
            examples: [
                "有時候小安不在教室。",
                "Yǒu shíhou Xiǎo Ān bú zài jiàoshì.",
                "Sometimes Xiao An is not in the classroom.",
                "我有時候找朋友。",
                "Wǒ yǒu shíhou zhǎo péngyǒu.",
                "Sometimes I look for my friends."
            ]
        },
        {
            id: "grammar-zhēnde",
            name: "真的 — Really / Truly",
            category: "Emphasis",
            explanation: "真的 means 'really' or 'truly'. It emphasizes that a feeling, opinion, or statement is genuine or strong.",
            examples: [
                "我真的很開心。",
                "Wǒ zhēnde hěn kāixīn.",
                "I am really happy.",
                "我真的覺得很好。",
                "Wǒ zhēnde juéde hěn hǎo.",
                "I really think it is good."
            ]
        },
        {
            id: "grammar-de-shíhou",
            name: "的時候 — When / At the Time When",
            category: "Time Clauses",
            explanation: "的時候 means 'when' or 'at the time when'. It connects a time or situation to what happens during that time.",
            examples: [
                "下課的時候，我想說話。",
                "Xiàkè de shíhou, wǒ xiǎng shuōhuà.",
                "When class ends, I want to talk.",
                "看到小安的時候，我很開心。",
                "Kàndào Xiǎo Ān de shíhou, wǒ hěn kāixīn.",
                "When I see Xiao An, I am very happy."
            ]
        },
        {
            id: "grammar-yìdiǎn",
            name: "一點 — A Little / A Bit",
            category: "Degree",
            explanation: "一點 means 'a little' or 'a bit'. 有一點 + adjective is commonly used to describe a small degree of a feeling or condition.",
            examples: [
                "我有一點不好意思。",
                "Wǒ yǒu yìdiǎn bù hǎoyìsi.",
    ...
    vocabulary: [
        { word: "阿豪", pinyin: "Āháo", meaning: "Ahao" },
        { word: "小安", pinyin: "Xiǎo Ān", meaning: "Xiao An" },
        { word: "小雅", pinyin: "Xiǎo Yǎ", meaning: "Xiao Ya" },
        { word: "說話", pinyin: "shuōhuà", meaning: "to speak / talk" },
        { word: "覺得", pinyin: "juéde", meaning: "to think / feel" },
        { word: "發現", pinyin: "fāxiàn", meaning: "to realize / discover" },
        { word: "一件事", pinyin: "yí jiàn shì", meaning: "one matter / one thing" },
        { word: "件", pinyin: "jiàn", meaning: "measure word for matters / things" },
        { word: "事", pinyin: "shì", meaning: "matter / thing" },
        { word: "下課", pinyin: "xiàkè", meaning: "class ends / break time" },
        { word: "找", pinyin: "zhǎo", meaning: "to look for" },
        { word: "旁邊", pinyin: "pángbiān", meaning: "beside / next to" },
        { word: "看到", pinyin: "kàndào", meaning: "to see" },
        { word: "以後", pinyin: "yǐhòu", meaning: "after / afterwards" },
        { word: "心裡", pinyin: "xīnlǐ", meaning: "in one's heart / mind" },
        { word: "時候", pinyin: "shíhou", meaning: "time / when" },
        { word: "告訴", pinyin: "gàosù", meaning: "to tell" },
        { word: "要不要", pinyin: "yào bú yào", meaning: "whether to / want or not" },
        { word: "最近", pinyin: "zuìjìn", meaning: "recently / lately" },
        { word: "平常", pinyin: "píngcháng", meaning: "usually / normally" },
        { word: "有時候", pinyin: "yǒu shíhou", meaning: "sometimes" },
        { word: "班上", pinyin: "bān shàng", meaning: "in the class" },
        { word: "班", pinyin: "bān", meaning: "class" },
        { word: "午餐", pinyin: "wǔcān", meaning: "lunch" },
        { word: "不在", pinyin: "bú zài", meaning: "not be at / not be there" },
        { word: "一點", pinyin: "yìdiǎn", meaning: "a little / a bit" },
        { word: "不好意思", pinyin: "bù hǎoyìsi", meaning: "embarrassed / sorry" },
        { word: "小", pinyin: "xiǎo", meaning: "small / little" },
        { word: "問題", pinyin: "wèntí", meaning: "question / problem" },
        { word: "知道", pinyin: "zhīdào", meaning: "to know" }
    ],
    reviewQuestions: [
        { meaning: "I think Xiao An is very cute.", answer: ["我", "覺得", "小安", "很", "可愛"] },
        { meaning: "Recently Ahao often looks for Xiao An.", answer: ["最近", "阿豪", "常常", "找", "小安"] },
        { meaning: "Sometimes Xiao An is not in class.", answer: ["有時候", "小安", "不在", "班上"] },
        { meaning: "When I see Xiao An, I am really happy.", answer: ["看到", "小安", "的時候", "我", "真的", "很", "開心"] },
        { meaning: "Should I tell Xiao An?", answer: ["我要不要", "告訴", "小安"] }
    ]
}
