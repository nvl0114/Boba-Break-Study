...
1: { 
    grammar: [ 
        { id: "svo", name: "S + V + O", category: "Sentence Structure", examples: ["我吃飯。", "你喝水。", "她看書。"] }, 
...
2: { 
    grammar: [ 
        { id: "de", name: "的", category: "Possession", examples: ["我的手機。", "你的書。", "她的媽媽。"] } 
    ], 
    vocabulary: [ 
...
3: { 
    grammar: [ 
        { id: "shi", name: "是", category: "Identity", examples: ["我是老師。", "她是醫生。", "他是學生。"] }, 
        { id: "bu-shi", name: "不是", category: "Negative Identity", examples: ["我不是老師。", "她不是醫生。", "他不是學生。"] }, 
        { id: "shi-ma", name: "是...嗎", category: "Identity Question", examples: ["你是老師嗎？", "她是醫生嗎？", "他是學生嗎？"] }, 
        { id: "shi-bu-shi", name: "是不是", category: "A-not-A Question", examples: ["你是不是老師？", "她是不是醫生？", "他是不是學生？"] }, 
        { id: "answer-shi", name: "Answer: 是", category: "Answer", examples: ["是。", "是，我是老師。", "是，她是醫生。"] }, 
        { id: "answer-bu-shi", name: "Answer: 不是", category: "Answer", examples: ["不是。", "不是，我不是老師。", "不是，她不是醫生。"] } 
    ], 
    vocabulary: [ 
...
4: { 
    grammar: [ 
        { id: "s-hen-adj", name: "S + 很 + Adj", category: "Adjective Sentence", examples: ["我很累。", "你很好。", "他很忙。"] }, 
        { id: "s-bu-adj", name: "S + 不 + Adj", category: "Negative Adjective Sentence", examples: ["我不累。", "你不好。", "她不高。"] }, 
        { id: "s-hen-adj-ma", name: "S + 很 + Adj + 嗎", category: "Adjective Question", examples: ["你很累嗎？", "你很好嗎？", "她很高嗎？"] }, 
        { id: "s-adj-bu-adj", name: "S + Adj + 不 + Adj", category: "A-not-A Adjective Question", examples: ["你累不累？", "你好不好？", "她高不高？"] }, 
        { id: "s-hen-v-o-ma", name: "S + 很 + V + O + 嗎", category: "Adverbial Question", examples: ["你很看書嗎？", "你很吃飯嗎？"] } 
    ], 
    vocabulary: [ 
...
5: { 
    grammar: [ 
        { id: "measure-word-ge", name: "Number / This / That + 個 + Noun", category: "Measure Word Structure", explanation: "In Mandarin, you cannot place a number, 'this' (這), or 'that' (那) directly in front of a noun. You must use the universal measure word 個 (gè) in between them.", examples: [ "一個人 (One person)", "這個問題 (This question / problem)", "那個地方 (That place)", "兩個月 (Two months)" ] } 
    ], 
    vocabulary: [ 
...
6: { 
    grammar: [ 
        { id: "jiao-what-name", name: "叫什麼名字", category: "Self-Introduction", explanation: "Used to ask someone's full name.", examples: ["你叫什麼名字？", "請問，您叫什麼名字？"] }, 
        { id: "jiao-name", name: "叫。。。", category: "Self-Introduction", explanation: "Used to state your name.", examples: ["我叫大衛。", "她叫美美。"] }, 
        { id: "wo-xing", name: "我姓。。。", category: "Self-Introduction", explanation: "Used to state your family name (surname).", examples: ["我姓王。", "我姓李。"] }, 
        { id: "gui-xing", name: "貴姓", category: "Self-Introduction", explanation: "A polite way to ask someone's honorable surname.", examples: ["請問您貴姓？"] }, 
        { id: "number-sui", name: "幾歲 & Number + 歲", category: "Age", explanation: "Used to ask and state age.", examples: ["你幾歲？", "我二十歲。"] }, 
        { id: "particle-ne", name: "S + 呢", category: "Question Particle", explanation: "Used to bounce a question back to the other person.", examples: ["我很好，你呢？", "我是台灣人，他呢？"] }, 
        { id: "question-word-shenme", name: "什麼", category: "Question Word", explanation: "Means 'what'.", examples: ["你叫什麼名字？", "這是什麼？"] }, 
        { id: "adverb-ye", name: "也", category: "Adverb", explanation: "Means 'also' or 'too'.", examples: ["我也是。", "我也喜歡聽音樂。"] } 
    ], 
    vocabulary: [ 
...
7: { 
    grammar: [ 
        { id: "zài-location", name: "Subject + 在 (Zài) + Location", category: "Location Pattern", explanation: "The word 在 (zài) acts as a preposition meaning 'at' or 'in'. It is placed before a location noun to tell where someone or something is located.", examples: ["我在家。", "你在學校。", "他在醫院。"] }, 
        { id: "subject-zài-location-verb", name: "Subject + 在 + Location + Verb", category: "Action at Location", explanation: "Unlike English, Chinese structure places the location before the action verb: Subject + [At Location] + [Verb].", examples: ["我在學校讀書。", "他在辦公室上班。", "他在公園運動。"] }, 
        { id: "ongoing-action", name: "Subject + 正在 (Zhèngzài) + Verb", category: "Ongoing Action", explanation: "To express that an action is currently in progress (equivalent to '-ing' in English), use 正在 (zhèngzài) or just 在 right before the verb.", examples: ["我正在上課。", "他正在玩遊戲。", "她正在教學。"] }, 
        { id: "question-where", name: "Question: 你在哪裡？ Answer: 我在...", category: "Interrogative & Answer", explanation: "To ask 'Where are you?', use 哪裡 (nǎlǐ). The response mirrors the pattern using 在 + Location.", examples: ["你在哪裡？", "我在公園。", "你在哪裡上班？"] } 
    ], 
    vocabulary: [ 
...
8: { 
    grammar: [ 
        { id: "have-objects", name: "S + 有 / 沒有 + O", category: "Possession", explanation: "Used to express having or not having something.", examples: ["我有一本書。", "我沒有錢。", "你有原子筆嗎？", "你有沒有鉛筆？"] }, 
        { id: "have-actions", name: "S + 有 / 沒有 + V (+O)", category: "Having Done / Experienced Actions", explanation: "Used to express having or not having done an action. Can be answered with 有 or 沒有.", examples: ["我有吃蛋糕。", "我沒有喝酒。", "你有記得嗎？", "有沒有學習英文？"] }, 
        { id: "existential-location", name: "Place + 有 + Thing / Person", category: "Existence at Location", explanation: "Used to indicate the existence of objects or people in a certain place.", examples: ["桌子上有一台電腦。", "教室裡有學生。"] } 
    ], 
    vocabulary: [ 
...
9: {
    ...
    vocabulary: [ 
        { hanzi: "歡迎光臨", pinyin: "huānyíng guānglín", meaning: "welcome (used when welcoming customers)", category: "Transaction" }, 
        { hanzi: "謝謝", pinyin: "xièxie", meaning: "thank you", category: "Polite Expression" }, 
        { hanzi: "不客氣", pinyin: "bú kèqi", meaning: "you're welcome", category: "Polite Expression" }, 
        { hanzi: "不會", pinyin: "bú huì", meaning: "you're welcome / no problem", category: "Polite Expression" }, 
        { hanzi: "對不起", pinyin: "duìbuqǐ", meaning: "sorry", category: "Apology" }, 
        { hanzi: "不好意思", pinyin: "bù hǎoyìsi", meaning: "excuse me / sorry", category: "Polite Expression" }, 
        { hanzi: "沒關係", pinyin: "méi guānxi", meaning: "it's okay / no problem", category: "Response" }, 
        { hanzi: "沒問題", pinyin: "méi wèntí", meaning: "no problem", category: "Response" }, 
        { hanzi: "請", pinyin: "qǐng", meaning: "please", category: "Polite Expression" }, 
        { hanzi: "問", pinyin: "wèn", meaning: "to ask", category: "Verb" }, 
        { hanzi: "多少", pinyin: "duōshao", meaning: "how much / how many", category: "Question Word" }, 
        { hanzi: "錢", pinyin: "qián", meaning: "money", category: "Object" }, 
        { hanzi: "多少錢", pinyin: "duōshao qián", meaning: "how much does it cost", category: "Question" }, 
        { hanzi: "元", pinyin: "yuán", meaning: "dollar / NT dollar (formal)", category: "Money" }, 
        { hanzi: "塊", pinyin: "kuài", meaning: "dollar / NT dollar (common spoken form)", category: "Money" }, 
        { hanzi: "買", pinyin: "mǎi", meaning: "to buy", category: "Verb" }, 
        { hanzi: "賣", pinyin: "mài", meaning: "to sell", category: "Verb" }, 
        { hanzi: "給", pinyin: "gěi", meaning: "to give / for", category: "Verb" }, 
        { hanzi: "有", pinyin: "yǒu", meaning: "to have / there is", category: "Verb" }, 
        { hanzi: "沒有", pinyin: "méiyǒu", meaning: "not have / there isn't", category: "Verb" }, 
        { hanzi: "完了", pinyin: "wán le", meaning: "finished / completed", category: "Grammar" }, 
        { hanzi: "了", pinyin: "le", meaning: "completed-action particle", category: "Grammar" }, 
        { hanzi: "這個", pinyin: "zhège", meaning: "this one", category: "Demonstrative" }, 
        { hanzi: "那個", pinyin: "nàge", meaning: "that one", category: "Demonstrative" }, 
        { hanzi: "東西", pinyin: "dōngxi", meaning: "thing / things", category: "Object" } 
    ], 
    reviewQuestions: [ 
        { meaning: "How much is this?", answer: ["這", "個", "多", "少", "錢"] }, 
        { meaning: "How much is that?", answer: ["那", "個", "多", "少", "錢"] }, 
        { meaning: "It's 50 dollars.", answer: ["五", "十", "塊"] }, 
        { meaning: "Please give me one.", answer: ["請", "給", "我", "一", "個"] }, 
        { meaning: "Sorry, it's sold out.", answer: ["對", "不", "起", "賣", "完", "了"] }, 
        { meaning: "Excuse me, do you have this?", answer: ["不", "好", "意", "思", "你", "有", "這", "個", "嗎"] }, 
        { meaning: "Thank you. — You're welcome.", answer: ["謝", "謝", "不", "客", "氣"] }, 
        { meaning: "Sorry. — It's okay.", answer: ["對", "不", "起", "沒", "關", "係"] } 
    ] 
},
...
10: {
    vocabulary: [
        { hanzi: "爺爺", pinyin: "yéye", meaning: "paternal grandfather", category: "Family" },
        { hanzi: "奶奶", pinyin: "nǎinai", meaning: "paternal grandmother", category: "Family" },
        { hanzi: "伯伯", pinyin: "bóbo", meaning: "father's older brother", category: "Family" },
        { hanzi: "伯母", pinyin: "bómǔ", meaning: "wife of father's older brother", category: "Family" },
        { hanzi: "叔叔", pinyin: "shūshu", meaning: "father's younger brother", category: "Family" },
        { hanzi: "嬸嬸", pinyin: "shěnshen", meaning: "wife of father's younger brother", category: "Family" },
        { hanzi: "姑姑", pinyin: "gūgu", meaning: "father's sister", category: "Family" },
        { hanzi: "姑丈", pinyin: "gūzhàng", meaning: "husband of father's sister", category: "Family" },
        { hanzi: "舅舅", pinyin: "jiùjiu", meaning: "mother's brother", category: "Family" },
        { hanzi: "舅媽", pinyin: "jiùmā", meaning: "wife of mother's brother", category: "Family" },
        { hanzi: "阿姨", pinyin: "āyí", meaning: "mother's sister", category: "Family" },
        { hanzi: "姨丈", pinyin: "yízhàng", meaning: "husband of mother's sister", category: "Family" },
        { hanzi: "堂", pinyin: "táng", meaning: "paternal-side cousin", category: "Family" },
        { hanzi: "表", pinyin: "biǎo", meaning: "maternal-side cousin / cousin from certain family relationships", category: "Family" },
        { hanzi: "兄弟姐妹", pinyin: "xiōngdì jiěmèi", meaning: "siblings", category: "Family" },
        { hanzi: "兄弟", pinyin: "xiōngdì", meaning: "brothers / male siblings", category: "Family" },
        { hanzi: "姐妹", pinyin: "jiěmèi", meaning: "sisters / female siblings", category: "Family" },
        { hanzi: "家人", pinyin: "jiārén", meaning: "family members", category: "Family" },
        { hanzi: "外公", pinyin: "wàigōng", meaning: "maternal grandfather", category: "Family" }, 
        { hanzi: "外婆", pinyin: "wàipó", meaning: "maternal grandmother", category: "Family" }, 
        { hanzi: "阿公", pinyin: "āgōng", meaning: "grandfather (Taiwanese style)", category: "Family" }, 
        { hanzi: "阿嬤", pinyin: "āmā", meaning: "grandmother (Taiwanese style)", category: "Family" } 
    ], 
    reviewQuestions: [ 
        { meaning: "My paternal grandfather", answer: ["我", "的", "爺", "爺"] }, 
        { meaning: "My paternal grandmother", answer: ["我", "的", "奶", "奶"] }, 
        { meaning: "My father's older brother", answer: ["我", "的", "伯", "伯"] }, 
        { meaning: "My father's younger brother", answer: ["我", "的", "叔", "叔"] }, 
        { meaning: "My father's sister", answer: ["我", "的", "姑", "姑"] }, 
        { meaning: "My mother's brother", answer: ["我", "的", "舅", "舅"] }, 
        { meaning: "My mother's sister", answer: ["我", "的", "阿", "姨"] }, 
        { meaning: "My family members", answer: ["我", "的", "家", "人"] }, 
        { meaning: "I have brothers and sisters.", answer: ["我", "有", "兄", "弟", "姐", "妹"] } 
    ] 
},
...
11: {
    ...
    vocabulary: [ 
        { hanzi: "跟", pinyin: "gēn", meaning: "with / and", category: "Conjunction" }, 
        { hanzi: "住在", pinyin: "zhù zài", meaning: "live in / at", category: "Verb" }, 
        { hanzi: "一起", pinyin: "yīqǐ", meaning: "together", category: "Adverb" }, 
        { hanzi: "時間", pinyin: "shíjiān", meaning: "time", category: "Noun" }, 
        { hanzi: "家裡", pinyin: "jiālǐ", meaning: "home / at home", category: "Location" }, 
        { hanzi: "但是", pinyin: "dànshì", meaning: "but", category: "Conjunction" }, 
        { hanzi: "可是", pinyin: "kěshì", meaning: "but / however", category: "Conjunction" }, 
        { hanzi: "唱歌", pinyin: "chànggē", meaning: "to sing / singing", category: "Verb" }, 
        { hanzi: "自拍", pinyin: "zìpāi", meaning: "to take a selfie", category: "Verb" }, 
        { hanzi: "今天", pinyin: "jīntiān", meaning: "today", category: "Time" }, 
        { hanzi: "星期六", pinyin: "xīngqíliù", meaning: "Saturday", category: "Time" }, 
        { hanzi: "多", pinyin: "duō", meaning: "many / much", category: "Adjective" }, 
        { hanzi: "天氣", pinyin: "tiānqì", meaning: "weather", category: "Noun" }, 
        { hanzi: "出去", pinyin: "chūqù", meaning: "go out", category: "Verb" }, 
        { hanzi: "都", pinyin: "dōu", meaning: "all / both", category: "Adverb" }, 
        { hanzi: "所以", pinyin: "suǒyǐ", meaning: "so / therefore", category: "Conjunction" }, 
        { hanzi: "因為", pinyin: "yīnwèi", meaning: "because", category: "Conjunction" }, 
        { hanzi: "然後", pinyin: "ránhòu", meaning: "then / afterwards", category: "Conjunction" }, 
        { hanzi: "如果", pinyin: "rúguǒ", meaning: "if", category: "Conjunction" }, 
        { hanzi: "或者", pinyin: "huòzhě", meaning: "or (statements)", category: "Conjunction" }, 
        { hanzi: "還是", pinyin: "háishì", meaning: "or (questions)", category: "Conjunction" }, 
        { hanzi: "還", pinyin: "hái", meaning: "still / also", category: "Adverb" }, 
        { hanzi: "麵", pinyin: "miàn", meaning: "noodles", category: "Food" } 
    ], 
    reviewQuestions: [ 
        { meaning: "I live together with my older brother.", answer: ["我", "跟", "哥哥", "住", "在", "一", "起"] }, 
        { meaning: "My younger sister also lives at home.", answer: ["妹", "妹", "也", "住", "在", "家", "裡"] }, 
        { meaning: "We all like eating meals and watching movies.", answer: ["我", "們", "都", "喜", "歡", "吃", "飯", "和", "看", "電", "影"] }, 
        { meaning: "My older brother also likes singing.", answer: ["哥", "哥", "還", "喜", "歡", "唱", "歌"] }, 
        { meaning: "My younger sister likes taking selfies, but my older brother doesn't.", answer: ["妹", "妹", "喜", "歡", "自", "拍", "可", "是", "哥", "哥", "不", "喜", "歡"] }, 
        { meaning: "Because the weather is good, we want to go out.", answer: ["因", "為", "天", "氣", "很", "好", "所", "以", "我", "們", "想", "出", "去"] }, 
        { meaning: "Then we go to the park together.", answer: ["然", "後", "我", "們", "一", "起", "去", "公", "園"] }, 
        { meaning: "If it rains, we will go home.", answer: ["如", "果", "下", "雨", "我", "們", "就", "回", "家"] }, 
        { meaning: "We can eat noodles or rice tonight.", answer: ["晚", "上", "我", "們", "可", "以", "吃", "麵", "或", "者", "吃", "飯"] }, 
        { meaning: "Do you want noodles or rice?", answer: ["你", "要", "吃", "麵", "還", "是", "吃", "飯"] } 
    ] 
},
...
12: { 
    grammar: [ 
        { id: "numbers-11-19", name: "十 (shí) + number", category: "Numbers (11–19)", examples: ["十二 (shí èr = 12)", "十八 (shí bā = 18)"] }, 
        { id: "numbers-20-99", name: "number + 十 (shí) + number", category: "Numbers (20–99)", examples: ["二十 (èr shí = 20)", "八十五 (bā shí wǔ = 85)"] }, 
        { id: "hundred-scale", name: "百 (bǎi) - Hundred", category: "Large Scale Numbers", examples: ["兩百 (liǎng bǎi = 200)", "五百三十五 (wǔ bǎi sān shí wǔ = 535)"] }, 
        { id: "thousand-scale", name: "千 (qiān) - Thousand", category: "Large Scale Numbers", examples: ["兩千 (liǎng qiān = 2000)", "八千三百五十六 (bā qiān sān bǎi wǔ shí liù = 8356)"] }, 
        { id: "wan-scale", name: "萬 (wàn) - Ten Thousand (Groups of 4 zeros)", category: "Large Scale Numbers", examples: ["兩萬 (liǎng wàn = 20000)", "一百萬 (yī bǎi wàn = 1,000,000)"] }, 
        { id: "currency-units", name: "塊 (kuài) / 元 (yuán) / 臺幣 (táibì)", category: "Currency Expressions", examples: ["臺幣 (táibì = NTD)", "五百塊 (wǔ bǎi kuài = 500 bucks)", "一百元 (yī bǎi yuán = 100 yuan)"] } 
    ], 
    vocabulary: [ 
...
14: {
    ...
    vocabulary: [ 
        ...
        { hanzi: "幾", pinyin: "jǐ", meaning: "how many; what number", category: "Question Word" }, 
        { hanzi: "什麼時候", pinyin: "shénme shíhou", meaning: "when", category: "Question Word" }, 
        { hanzi: "生日", pinyin: "shēngrì", meaning: "birthday", category: "Time" }, 
        { hanzi: "對了", pinyin: "duì le", meaning: "oh, by the way; that's right", category: "Expression" }, 
        { hanzi: "可能", pinyin: "kěnéng", meaning: "maybe; possibly; possible", category: "Adverb" }, 
        { hanzi: "吧", pinyin: "ba", meaning: "sentence-final particle; used for suggestions or uncertainty", category: "Grammar" } 
    ], 
    reviewQuestions: [ 
        { meaning: "What day is it today?", answer: ["今天", "是", "星期", "幾"] }, 
        { meaning: "Today is Monday.", answer: ["今天", "是", "星期", "一"] }, 
        { meaning: "What is today's date?", answer: ["今天", "幾", "月", "幾", "號"] }, 
        { meaning: "Today is August 24th.", answer: ["今天", "是", "八", "月", "二", "十", "四", "號"] }, 
        { meaning: "What is your birthday?", answer: ["你的", "生日", "是", "幾", "月", "幾", "號"] }, 
        { meaning: "My birthday is June 15th.", answer: ["我的", "生日", "是", "六", "月", "十", "五", "號"] }, 
        { meaning: "When do you go to the library?", answer: ["你", "什麼時候", "去", "圖書館"] }, 
        { meaning: "When do you take the exam?", answer: ["你", "什麼時候", "考試"] }, 
        { meaning: "When do you go home?", answer: ["你", "什麼時候", "回家"] }, 
        { meaning: "When do you swim?", answer: ["你", "什麼時候", "游泳"] } 
    ] 
},
...
15: {
    ...
    vocabulary: [ 
        { hanzi: "現在", pinyin: "xiànzài", meaning: "now", category: "Time" }, 
        { hanzi: "時間", pinyin: "shíjiān", meaning: "time", category: "Time" }, 
        { hanzi: "點", pinyin: "diǎn", meaning: "o'clock; hour", category: "Time" }, 
        { hanzi: "分", pinyin: "fēn", meaning: "minute", category: "Time" }, 
        { hanzi: "半", pinyin: "bàn", meaning: "half", category: "Time" }, 
        { hanzi: "刻", pinyin: "kè", meaning: "quarter of an hour; 15 minutes", category: "Time" }, 
        { hanzi: "一刻", pinyin: "yí kè", meaning: "a quarter of an hour; 15 minutes", category: "Time" }, 
        { hanzi: "三刻", pinyin: "sān kè", meaning: "three quarters of an hour; 45 minutes", category: "Time" }, 
        { hanzi: "秒", pinyin: "miǎo", meaning: "second", category: "Time" }, 
        { hanzi: "清晨", pinyin: "qīngchén", meaning: "early morning; dawn", category: "Time" }, 
        { hanzi: "早晨", pinyin: "zǎochén", meaning: "early morning", category: "Time" }, 
        { hanzi: "早上", pinyin: "zǎoshang", meaning: "morning", category: "Time" }, 
        { hanzi: "上午", pinyin: "shàngwǔ", meaning: "morning; a.m.", category: "Time" }, 
        { hanzi: "中午", pinyin: "zhōngwǔ", meaning: "noon", category: "Time" }, 
        { hanzi: "下午", pinyin: "xiàwǔ", meaning: "afternoon; p.m.", category: "Time" }, 
        { hanzi: "傍晚", pinyin: "bàngwǎn", meaning: "early evening; around sunset", category: "Time" }, 
        { hanzi: "晚上", pinyin: "wǎnshang", meaning: "evening; night", category: "Time" }, 
        { hanzi: "夜裡", pinyin: "yèlǐ", meaning: "at night; during the night", category: "Time" }, 
        { hanzi: "凌晨", pinyin: "língchén", meaning: "early morning; after midnight", category: "Time" } 
    ], 
    reviewQuestions: [ 
        { meaning: "What time is it now?", answer: ["現在", "幾", "點"] }, 
        { meaning: "It is three o'clock now.", answer: ["現在", "三", "點"] }, 
        { meaning: "It is 3:05 now.", answer: ["現在", "三", "點", "五", "分"] }, 
        { meaning: "It is 8:20 now.", answer: ["現在", "八", "點", "二", "十", "分"] }, 
        { meaning: "It is 3:30 now.", answer: ["現在", "三", "點", "半"] }, 
        { meaning: "It is 3:15 now.", answer: ["現在", "三", "點", "一刻"] }, 
        { meaning: "It is 3:45 now.", answer: ["現在", "三", "點", "三刻"] }, 
        { meaning: "It is 10 a.m.", answer: ["上午", "十", "點"] }, 
        { meaning: "It is 3 p.m.", answer: ["下午", "三", "點"] }, 
        { meaning: "It is 8 p.m.", answer: ["晚上", "八", "點"] }, 
        { meaning: "I have class at 8 in the morning.", answer: ["我", "早上", "八", "點", "上課"] }, 
        { meaning: "I eat lunch at 12 noon.", answer: ["我", "中午", "十", "二", "點", "吃飯"] } 
    ] 
},
...
16: {
    grammar: [
        ...
        },
        {
            ...
            examples: [
                "上個星期我準備課程。 — Last year I prepared for the course.",
                "下個星期我要練習。 — Next year I need to practice."
            ]
        },
        {
    ...
    vocabulary: [ 
        ...
        { hanzi: "暑假", pinyin: "shǔjià", meaning: "summer vacation", category: "Time" }, 
        { hanzi: "去", pinyin: "qù", meaning: "to go", category: "Actions" }, 
        { hanzi: "中國", pinyin: "Zhōngguó", meaning: "China", category: "Places" }, 
        { hanzi: "了", pinyin: "le", meaning: "completed action / change", category: "Grammar" }, 
        { hanzi: "北京", pinyin: "Běijīng", meaning: "Beijing", category: "Places" }, 
        { hanzi: "上海", pinyin: "Shànghǎi", meaning: "Shanghai", category: "Places" }, 
        { hanzi: "好吃", pinyin: "hǎochī", meaning: "delicious", category: "Descriptions" }, 
        { hanzi: "漂亮", pinyin: "piàoliang", meaning: "beautiful", category: "Descriptions" }, 
        { hanzi: "地方", pinyin: "dìfāng", meaning: "place", category: "Places" }, 
        { hanzi: "每天", pinyin: "měitiān", meaning: "every day", category: "Time" }, 
        { hanzi: "開心", pinyin: "kāixīn", meaning: "happy", category: "Feelings" }, 
        { hanzi: "回", pinyin: "huí", meaning: "to return", category: "Actions" }, 
        { hanzi: "到", pinyin: "dào", meaning: "to arrive / reach", category: "Actions" }, 
        { hanzi: "以後", pinyin: "yǐhòu", meaning: "after / afterwards", category: "Time" }, 
        { hanzi: "已經", pinyin: "yǐjīng", meaning: "already", category: "Time" }, 
        { hanzi: "開始", pinyin: "kāishǐ", meaning: "to start / begin", category: "Actions" }, 
        { hanzi: "今年", pinyin: "jīnnián", meaning: "this year", category: "Time" }, 
        { hanzi: "又", pinyin: "yòu", meaning: "again", category: "Adverbs" }, 
        { hanzi: "韓國", pinyin: "Hánguó", meaning: "Korea", category: "Places" }, 
        { hanzi: "最", pinyin: "zuì", meaning: "most", category: "Adverbs" }, 
        { hanzi: "餐廳", pinyin: "cāntīng", meaning: "restaurant", category: "Places" }, 
        { hanzi: "那裡", pinyin: "nàlǐ", meaning: "there", category: "Places" }, 
        { hanzi: "食物", pinyin: "shíwù", meaning: "food", category: "Food" }, 
        { hanzi: "準備", pinyin: "zhǔnbèi", meaning: "to prepare", category: "Actions" }, 
        { hanzi: "課程", pinyin: "kèchéng", meaning: "course", category: "School" }, 
        { hanzi: "雖然", pinyin: "suīrán", meaning: "although", category: "Connectors" }, 
        { hanzi: "想念", pinyin: "xiǎngniàn", meaning: "to miss", category: "Feelings" }, 
        { hanzi: "明年", pinyin: "míngnián", meaning: "next year", category: "Time" }, 
        { hanzi: "泰國", pinyin: "Tàiguó", meaning: "Thailand", category: "Places" }, 
        { hanzi: "聽說", pinyin: "tīngshuō", meaning: "I heard / reportedly", category: "Expressions" }, 
        { hanzi: "期待", pinyin: "qīdài", meaning: "to look forward to", category: "Feelings" }, 
        { hanzi: "次", pinyin: "cì", meaning: "time / occurrence", category: "Measure Words" }, 
        { hanzi: "旅行", pinyin: "lǚxíng", meaning: "travel / trip", category: "Activities" }, 
        { hanzi: "這裡", pinyin: "zhèlǐ", meaning: "here", category: "Places" }, 
        { hanzi: "要", pinyin: "yào", meaning: "to want / need", category: "Actions" }, 
        { hanzi: "上", pinyin: "shàng", meaning: "up / previous", category: "Time" }, 
        { hanzi: "下", pinyin: "xià", meaning: "down / following", category: "Time" }, 
        { hanzi: "上個星期", pinyin: "shàng ge xīngqí", meaning: "last week", category: "Time" }, 
        { hanzi: "下個星期", pinyin: "xià ge xīngqí", meaning: "next week", category: "Time" } 
    ], 
    reviewQuestions: [ 
        { meaning: "Last year I went to China.", answer: ["去年", "我", "去", "中國"] }, 
        { meaning: "This year I went to Korea.", answer: ["今年", "我", "去", "韓國"] }, 
        { meaning: "Next year I will go to Thailand.", answer: ["明年", "我", "去", "泰國"] }, 
        { meaning: "I went to Beijing.", answer: ["我", "去", "了", "北京"] }, 
        { meaning: "We ate delicious food.", answer: ["我們", "吃", "了", "好吃", "的", "東西"] }, 
        { meaning: "I have already returned to Taiwan.", answer: ["我", "已經", "回", "台灣", "了"] }, 
        { meaning: "I have already started the course.", answer: ["我", "已經", "開始", "課程", "了"] }, 
        { meaning: "Beijing has many beautiful places.", answer: ["北京", "有", "很多", "漂亮", "的", "地方"] }, 
        { meaning: "I miss China and Korea.", answer: ["我", "很", "想念", "中國", "和", "韓國"] }, 
        { meaning: "I heard that Thailand has many beautiful places.", answer: ["我", "聽說", "泰國", "有", "很多", "漂亮", "的", "地方"] }, 
        { meaning: "I am looking forward to this trip.", answer: ["我", "很", "期待", "這", "次", "旅行"] }, 
        { meaning: "Last week I prepared for the course.", answer: ["上個星期", "我", "準備", "課程"] }, 
        { meaning: "Next week I need to practice.", answer: ["下個星期", "我", "要", "練習"] } 
    ] 
},
...
17: {
    ...
    vocabulary: [ 
        { hanzi: "親切", pinyin: "qīnqiè", meaning: "kind / friendly", category: "Adjective" }, 
        { hanzi: "所", pinyin: "suǒ", meaning: "measure word for buildings / institutions", category: "Measure Word" }, 
        { hanzi: "休息", pinyin: "xiūxi", meaning: "to rest / have a day off", category: "Verb" }, 
        { hanzi: "坐", pinyin: "zuò", meaning: "to take / ride / sit", category: "Verb" }, 
        { hanzi: "公車", pinyin: "gōngchē", meaning: "bus", category: "Object" }, 
        { hanzi: "教", pinyin: "jiāo", meaning: "to teach", category: "Verb" }, 
        { hanzi: "常常", pinyin: "chángcháng", meaning: "often", category: "Adverb" }, 
        { hanzi: "長得", pinyin: "zhǎng de", meaning: "to look / appear", category: "Verb" }, 
        { hanzi: "答案", pinyin: "dá'àn", meaning: "answer", category: "Noun" }, 
        { hanzi: "多大", pinyin: "duō dà", meaning: "how old / how big", category: "Phrase" }, 
        { hanzi: "幾點", pinyin: "jǐ diǎn", meaning: "what time", category: "Time" }, 
        { hanzi: "怎麼", pinyin: "zěnme", meaning: "how", category: "Question Word" }, 
        { hanzi: "怎麼樣", pinyin: "zěnmeyàng", meaning: "how / what is ... like", category: "Question Word" }, 
        { hanzi: "怎麼辦", pinyin: "zěnmebàn", meaning: "what should I do / what should we do", category: "Phrase" }, 
        { hanzi: "為什麼", pinyin: "wèishéme", meaning: "why", category: "Question Word" }, 
        { hanzi: "誰", pinyin: "shéi", meaning: "who", category: "Question Word" } 
    ], 
    reviewQuestions: [ 
        { meaning: "Who is my friend?", answer: ["誰", "是", "我的", "朋友"] }, 
        { meaning: "Where does Xiaomei work?", answer: ["小美", "在哪裡", "工作"] }, 
        { meaning: "Why does Xiaomei like her job?", answer: ["小美", "為什麼", "喜歡", "她的", "工作"] }, 
        { meaning: "How does Xiaomei go to school?", answer: ["小美", "怎麼", "去", "學校"] }, 
        { meaning: "What time does Xiaomei go to work?", answer: ["小美", "幾點", "去", "上班"] }, 
        { meaning: "How old is Xiaomei?", answer: ["小美", "多大"] }, 
